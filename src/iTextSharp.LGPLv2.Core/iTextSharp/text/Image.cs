...
public abstract class Image : Rectangle
{
    ...
    ///     Gets an instance of an Image.
    /// </summary>
    /// <param name="imgb">A byte array.
    /// Supported image formats: Jpeg, Gif, Png, Bmp, Tiff, Wmf, Jpeg2000 </param>
    /// <returns>A iTextSharp Image object.</returns>
    public static Image GetInstance(byte[] imgb)
    {
        ...
        throw new IOException(message: "The byte array is not a recognized image format.");
    }
